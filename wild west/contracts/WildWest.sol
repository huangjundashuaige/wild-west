...
contract WildWest {
    ...
    boardPlay[] playBoards;
    uint playBoardsLength;
    User[] users;
    uint usersLength;
    ...
    function getPlayBoards(uint id)public
    returns(
            string memory,
            string memory,
            uint
        ...
        return
        (
                playBoards[id].killer,
                playBoards[id].kill,
                playBoards[id].earn
        );
    }
    function getPlayBoardsLength()public returns(uint){
        return playBoardsLength;
    }
    function getUsers(uint id)public
    returns(
        string memory,
        uint,
        uint
    ...
    function getUsersLength()public  returns(uint){
        return usersLength;
    }
    //************ 
